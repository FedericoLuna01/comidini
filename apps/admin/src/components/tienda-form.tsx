...
import { Clock, MapPin, Phone, Mail, Globe, Truck, Store, Calendar } from "lucide-react";
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Completa la información de tu tienda para que los clientes puedan encontrarte.
        </p>
      </div>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Datos de contacto para que los clientes puedan comunicarse contigo
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="tienda@ejemplo.com" type="email" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <div className="space-y-4">
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                      <div className="space-y-0.5">
                        <FormLabel className="text-base">Acepta Entregas</FormLabel>
                        <FormDescription>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                      <div className="space-y-0.5">
                        <FormLabel className="text-base">Acepta Recogida</FormLabel>
                        <FormDescription>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                      <div className="space-y-0.5">
                        <FormLabel className="text-base">Acepta Reservas</FormLabel>
                        <FormDescription>
