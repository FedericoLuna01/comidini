...
import { MapPin, Star, Percent, Download, Play } from "lucide-react";
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                Encontrá bares, restaurantes y cafeterías cerca tuyo, aprovechá promociones exclusivas y ganá puntos que
                podés canjear por beneficios. ¡La movida gastronómica está en tus manos!
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6">
              <div className="text-center">
                <div className="text-3xl font-fredoka font-bold text-primary">1M+</div>
                <div className="text-sm text-gray-600">Usuarios activos</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-fredoka font-bold text-primary">5K+</div>
                <div className="text-sm text-gray-600">Restaurantes</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-fredoka font-bold text-primary">50%</div>
            ...
            <div className="text-sm text-gray-500">
              Disponible en Buenos Aires, Rosario, Santiago y pronto en toda Latinoamérica
            </div>
          </div>
                ...
                <div className="w-full h-full bg-white rounded-[2rem] overflow-hidden relative">
                  ...
                  <div className="p-4 space-y-4">
                    ...
                    <div className="bg-gray-100 rounded-full px-4 py-3 flex items-center space-x-2">
                      ...
                      <span className="text-gray-600">Buscar cerca de Palermo...</span>
                    </div>

                    {/* Quick Filters */}
                    <div className="flex space-x-2">
                      <div className="bg-primary text-white px-4 py-2 rounded-full text-sm">Todos</div>
                      <div className="bg-gray-100 px-4 py-2 rounded-full text-sm">🍕 Pizza</div>
                      <div className="bg-gray-100 px-4 py-2 rounded-full text-sm">☕ Café</div>
                    </div>
                    ...
                    <div className="space-y-3">
                      <div className="bg-white border rounded-xl p-4 shadow-sm">
                        <div className="flex justify-between items-start mb-2">
                          ...
                          <div className="bg-primary text-white px-2 py-1 rounded-full text-xs font-bold">-30%</div>
                        </div>
                        <p className="text-sm text-gray-600">Cerveza artesanal • Palermo</p>
                        <div className="flex items-center justify-between mt-2">
                          <div className="flex items-center space-x-1">
                            <Star className="w-4 h-4 text-yellow-500 fill-current" />
                            <span className="text-sm">4.8</span>
                          </div>
                          <div className="text-primary font-semibold text-sm">+120 puntos</div>
                        </div>
                      </div>
                      ...
                      <div className="bg-white border rounded-xl p-4 shadow-sm">
                        <div className="flex justify-between items-start mb-2">
                          ...
                          <div className="bg-primary text-white px-2 py-1 rounded-full text-xs font-bold">-25%</div>
                        </div>
                        <p className="text-sm text-gray-600">Café histórico • San Telmo</p>
                        <div className="flex items-center justify-between mt-2">
                          <div className="flex items-center space-x-1">
                            <Star className="w-4 h-4 text-yellow-500 fill-current" />
                            <span className="text-sm">4.9</span>
                          </div>
                          <div className="text-primary font-semibold text-sm">+95 puntos</div>
                        </div>
                      </div>
                    </div>
                  </div>
