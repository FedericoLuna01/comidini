import { Star, Gift, Trophy, Zap, Coffee, Pizza, Clock } from "lucide-react";
...
const PointsSystem = () => {
  const rewards = [
    ...
    { points: 2000, reward: "Experiencia VIP", icon: Trophy, color: "bg-yellow-500" },
  ];
        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div className="space-y-4">
                <div className="w-16 h-16 gradient-comidini rounded-2xl flex items-center justify-center mx-auto">
                  <span className="text-white font-fredoka font-bold text-2xl">1</span>
                </div>
                <h3 className="text-xl font-fredoka font-semibold">Consumís</h3>
                <p className="text-gray-600">Por cada $100 que gastes, ganás 10 puntos automáticamente</p>
              </div>

              <div className="space-y-4">
                <div className="w-16 h-16 gradient-comidini rounded-2xl flex items-center justify-center mx-auto">
                  <span className="text-white font-fredoka font-bold text-2xl">2</span>
                </div>
                <h3 className="text-xl font-fredoka font-semibold">Acumulás</h3>
                <p className="text-gray-600">Tus puntos se suman y podés ver tu progreso en tiempo real</p>
              </div>

              <div className="space-y-4">
                <div className="w-16 h-16 gradient-comidini rounded-2xl flex items-center justify-center mx-auto">
                  <span className="text-white font-fredoka font-bold text-2xl">3</span>
                </div>
                <h3 className="text-xl font-fredoka font-semibold">Canjeás</h3>
                <p className="text-gray-600">Usá tus puntos para obtener descuentos y experiencias únicas</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8 mb-16 border border-gray-100">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-fredoka font-bold mb-2">Tu Progreso</h3>
            ...
            <div className="max-w-md mx-auto">
              ...
              <div className="text-center mb-8">
                <div className="w-20 h-20 gradient-comidini rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-white font-fredoka font-bold text-2xl">MF</span>
                </div>
              ...
              <div className="gradient-comidini rounded-2xl p-6 text-white text-center mb-6">
                <div className="text-4xl font-fredoka font-bold mb-2">1,247</div>
              ...
              <div className="bg-gray-50 rounded-2xl p-6 mb-6">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex-1">
                    <div className="text-sm font-medium">Cena para 2 personas</div>
                    <div className="w-full bg-gray-200 rounded-full h-2 mt-1">
                      <div className="gradient-comidini h-2 rounded-full" style={{ width: "83%" }}></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3">
                <h5 className="font-semibold text-gray-900">Actividad reciente</h5>
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-xl">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <div className="text-sm font-medium">Café gratis canjeado</div>
          ...
          <div className="text-center mb-12">
            <h3 className="text-3xl font-fredoka font-bold mb-4">Canjeá tus puntos</h3>
            <p className="text-gray-600">Elegí entre cientos de recompensas disponibles</p>
          </div>
            ...
            {rewards.map((reward, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="space-y-2">
                    <div className="text-2xl font-fredoka font-bold text-ring">{reward.points}</div>
                    <div className="text-sm font-medium text-gray-900">{reward.reward}</div>
                  </div>
